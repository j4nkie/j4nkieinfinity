   	...
   	<div class="row portfolio-content">
   		<div class="col-twelve">
   			<div id="folio-wrap" class="bricks-wrapper">
	               ...
	               <div class="item-wrap animate-this" data-src="<?php echo (!empty(get_parent_theme_file_uri('/images/front/image.jpg'))) ? get_parent_theme_file_uri('/images/front/image.png') : get_parent_theme_file_uri('/images/front/image.jpg') ?>" data-sub-html="#01" >
	                  <a href="#" class="overlay">
	                  	<img src="<?php echo (!empty(get_parent_theme_file_uri('/images/front/image.jpg'))) ? get_parent_theme_file_uri('/images/front/image.png') : get_parent_theme_file_uri('/images/front/image.jpg') ?>" alt="Yeat">
	                     <div class="item-text">
	                     	<span class="folio-types">
		     					      Music
		     					   </span>
		     					   <h3 class="folio-title">Yeat</h3>
		     					</div>
	                  </a>
            ...
            <ul class="slides">
               ...
               <li>
                  ...
                  <div class="testimonial-author">
                    	<img src="<?php echo get_parent_theme_file_uri('/images/avatars/user-02.jpg'); ?>" alt="Author image">
               ...
               <li>
                  ...
                  nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris.
               	...
               	<div class="testimonial-author">
                    	<img src="<?php echo get_parent_theme_file_uri('/images/avatars/user-03.jpg'); ?>" alt="Author image">
                    	<div class="author-info">
                    		John Doe
